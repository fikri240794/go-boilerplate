...
const (
	...
	Boilerplate_BulkCreateGuests_FullMethodName = "/protobuf_boilerplate.Boilerplate/BulkCreateGuests"
	Boilerplate_BulkUpdateGuests_FullMethodName = "/protobuf_boilerplate.Boilerplate/BulkUpdateGuests"
	Boilerplate_BulkDeleteGuests_FullMethodName = "/protobuf_boilerplate.Boilerplate/BulkDeleteGuests"
)
...
type BoilerplateClient interface {
	...
	BulkCreateGuests(ctx context.Context, in *BulkCreateGuestsRequestVM, opts ...grpc.CallOption) (*BulkCreateGuestsResponseVM, error)
	BulkUpdateGuests(ctx context.Context, in *BulkUpdateGuestsRequestVM, opts ...grpc.CallOption) (*BulkUpdateGuestsResponseVM, error)
	BulkDeleteGuests(ctx context.Context, in *BulkDeleteGuestsRequestVM, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *boilerplateClient) BulkCreateGuests(ctx context.Context, in *BulkCreateGuestsRequestVM, opts ...grpc.CallOption) (*BulkCreateGuestsResponseVM, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BulkCreateGuestsResponseVM)
	err := c.cc.Invoke(ctx, Boilerplate_BulkCreateGuests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boilerplateClient) BulkUpdateGuests(ctx context.Context, in *BulkUpdateGuestsRequestVM, opts ...grpc.CallOption) (*BulkUpdateGuestsResponseVM, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BulkUpdateGuestsResponseVM)
	err := c.cc.Invoke(ctx, Boilerplate_BulkUpdateGuests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boilerplateClient) BulkDeleteGuests(ctx context.Context, in *BulkDeleteGuestsRequestVM, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Boilerplate_BulkDeleteGuests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BoilerplateServer interface {
	...
	BulkCreateGuests(context.Context, *BulkCreateGuestsRequestVM) (*BulkCreateGuestsResponseVM, error)
	BulkUpdateGuests(context.Context, *BulkUpdateGuestsRequestVM) (*BulkUpdateGuestsResponseVM, error)
	BulkDeleteGuests(context.Context, *BulkDeleteGuestsRequestVM) (*emptypb.Empty, error)
...
func (UnimplementedBoilerplateServer) DeleteGuestByID(context.Context, *DeleteGuestByIDRequestVM) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteGuestByID not implemented")
}
func (UnimplementedBoilerplateServer) FindAllGuest(context.Context, *FindAllGuestRequestVM) (*FindAllGuestResponseVM, error) {
	return nil, status.Error(codes.Unimplemented, "method FindAllGuest not implemented")
}
func (UnimplementedBoilerplateServer) FindGuestByID(context.Context, *FindGuestByIDRequestVM) (*GuestResponseVM, error) {
	return nil, status.Error(codes.Unimplemented, "method FindGuestByID not implemented")
}
func (UnimplementedBoilerplateServer) UpdateGuestByID(context.Context, *UpdateGuestByIDRequestVM) (*GuestResponseVM, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateGuestByID not implemented")
}
func (UnimplementedBoilerplateServer) BulkCreateGuests(context.Context, *BulkCreateGuestsRequestVM) (*BulkCreateGuestsResponseVM, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkCreateGuests not implemented")
}
func (UnimplementedBoilerplateServer) BulkUpdateGuests(context.Context, *BulkUpdateGuestsRequestVM) (*BulkUpdateGuestsResponseVM, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkUpdateGuests not implemented")
}
func (UnimplementedBoilerplateServer) BulkDeleteGuests(context.Context, *BulkDeleteGuestsRequestVM) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkDeleteGuests not implemented")
}
...
func RegisterBoilerplateServer(s grpc.ServiceRegistrar, srv BoilerplateServer) {
	// If the following call panics, it indicates UnimplementedBoilerplateServer was
...
func _Boilerplate_BulkCreateGuests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkCreateGuestsRequestVM)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoilerplateServer).BulkCreateGuests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boilerplate_BulkCreateGuests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoilerplateServer).BulkCreateGuests(ctx, req.(*BulkCreateGuestsRequestVM))
	}
	return interceptor(ctx, in, info, handler)
}

func _Boilerplate_BulkUpdateGuests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkUpdateGuestsRequestVM)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoilerplateServer).BulkUpdateGuests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boilerplate_BulkUpdateGuests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoilerplateServer).BulkUpdateGuests(ctx, req.(*BulkUpdateGuestsRequestVM))
	}
	return interceptor(ctx, in, info, handler)
}

func _Boilerplate_BulkDeleteGuests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkDeleteGuestsRequestVM)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoilerplateServer).BulkDeleteGuests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boilerplate_BulkDeleteGuests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoilerplateServer).BulkDeleteGuests(ctx, req.(*BulkDeleteGuestsRequestVM))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Boilerplate_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BulkCreateGuests",
			Handler:    _Boilerplate_BulkCreateGuests_Handler,
		},
		{
			MethodName: "BulkUpdateGuests",
			Handler:    _Boilerplate_BulkUpdateGuests_Handler,
		},
		{
			MethodName: "BulkDeleteGuests",
			Handler:    _Boilerplate_BulkDeleteGuests_Handler,
		},
	},
